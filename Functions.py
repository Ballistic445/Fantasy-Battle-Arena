...
Hammer = Weapon("Hammer", [WeaponProfile("Slam", 25, 50, 2, 2, 0)], 15)
Cleaver = Weapon("Cleaver", [WeaponProfile("Slash", 12, 25, 2, 1, 3), WeaponProfile("Eviscerate", 20, 40, 1.5, 2, 4)], 15)
Dagger = Weapon("Dagger", [WeaponProfile("Jab", 8, 35, 1.75, 1, 4), WeaponProfile("Slash", 4, 50, 2, 1, 2)], 15)
Mace = Weapon("Mace", [WeaponProfile("Strike", 18, 10, 1.25, 1, 2), WeaponProfile("Bash", 30, 30, 1.4, 2, 3)], 15)
Greatsword = Weapon ("Greatsword", [WeaponProfile("Plunge", 38, 30, 1.5, 2, 0), WeaponProfile("Sweep", 18, 20, 1.5, 1, 0)], 20)